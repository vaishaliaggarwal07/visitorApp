            ...
            child: FutureBuilder<List<Visitor>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<Visitor> displayList = filteredtVisitorsList.isNotEmpty
                  ...
                  return Column(children: [
                              ...
                              child: TextField(
                                onChanged: (value) async {
                                  setState(() {
                                    filteredtVisitorsList = visitorsList
                                        .where((visitor) => visitor.visitor_name
                                            .toLowerCase()
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelStyle: TextStyle(
                                      ...
                                      fontFamily: 'Roboto'),
                                  prefixIcon: Icon(Icons.search,
                                      color: Color(0xFFFE4C2D), size: 15),
                                  border: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(10),
                                      borderSide:
                                          BorderSide(color: Color(0xFFFE4C2D))),
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(10),
                                    side: BorderSide(
                                        color: Color(0xFFF39D23), width: 0.3),
                                  ),
                                ),
                                child: Text(
                                  'Select Date Range',
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(30, 10, 30, 4),
                      child: TextButton(
                        onPressed: () {},
                        style: ButtonStyle(
                          shape:
                              ...
                              child: Row(
                                ...
                                children: [
                                  FutureBuilder<ImageProvider>(
                                      future:
                                          _fetchVisitorImage(visitor.image_url),
                                      builder: (context, snapshot) {
